...
@app.route("/skill/<string:skill_assignment_id>/<string:Course_ID>/<string:Skill_ID>/", methods=['GET','POST'])
def skill_to_course_assignment(skill_assignment_id,Skill_ID,Course_ID):
    ...
    #data = request.get_json()
    #print("poopo" + data)
    new_skill_assignment = Skill_Assign(skill_assignment_id,Course_ID,Skill_ID)
