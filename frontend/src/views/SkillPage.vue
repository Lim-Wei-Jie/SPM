        ...
        <div class="container mx-auto my-8">
            <div v-if="loading">
                ...
                <div class="space-y-3 my-4">
                    ...
                    <div class="flex" v-for="course of skillCourses">
    ...
    ;(async() => {
        try {
            ...
            // get courses with particular skill ID
                ...
                skillCourses.value = await getCoursesBySkill(skill.skillID)
                ...
                for (var course of skillCourses) {
                    ...
                    */
                    ...
                    if (skill.coursesBySkillName[skill.skillName]) {
                        skill.coursesBySkillName[skill.skillName].courses[course.Course_Name] = course
                    // skillName does not exist in object
                    } 
                    else {
                        skill.coursesBySkillName[skill.skillName] = {
            ...
            store.storeSkill(skill.skillID, skill.skillDesc, skill.skillName, skill.coursesBySkillName)
